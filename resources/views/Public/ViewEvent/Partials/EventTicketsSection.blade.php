                    ...
                    <div class="content">
                        <div class="tickets_table_wrap">
                            <table class="table">
                                ...
                                $is_free_event = true;
                                ?>
                                @foreach($tickets->where('is_hidden', '!=', '1') as $ticket)
                                    <tr class="ticket" property="offers" typeof="Offer2">
                                        <td>
											<p class="ticket-title semibold" property="name" style="font-size:20px">
												{{$ticket->type}}
											</p>
										 ...
										 <td style="width:100px; text-align: right;">
											<div style="margin-right: 20px;">
													@if($ticket->is_normal == '2')
														<span >Normal</span>
													@elseif($ticket->is_normal == '3')
														<span >Free</span>
													@elseif($ticket->is_normal == '4')
														<span >Donation</span>	
													@endif
											</div>
										</td>
										<td style="width:100px; text-align: right;">
                                            <div style="margin-right: 20px;">
												@if($ticket->type == 'Couples')
													<span >Couples</span>
												@elseif($ticket->type == 'Single Male')
													<span >Male</span>
												@elseif($ticket->type == 'Single Female')
													<span >Female</span>	
												@endif												
											</div>
										</td>
