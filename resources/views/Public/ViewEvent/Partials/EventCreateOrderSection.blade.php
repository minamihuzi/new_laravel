<section id='order_form' class="container">
                            ...
                            @foreach($tickets as $ticket)
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @if($ticket['ticket']['type']=='Couples')
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {!! Form::label("ticket_holder_first_name[{$i}][{$ticket['ticket']['id']}]", trans("Public_ViewEvent.first_name")) !!}
                                                    {!! Form::text("ticket_holder_second_name[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "ticket_holder_first_name.$i.{$ticket['ticket']['id']} ticket_holder_first_name form-control"]) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {!! Form::label("ticket_holder_last_name[{$i}][{$ticket['ticket']['id']}]", trans("Public_ViewEvent.last_name")) !!}
                                                    {!! Form::text("ticket_holder_second_last[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "ticket_holder_last_name.$i.{$ticket['ticket']['id']} ticket_holder_last_name form-control"]) !!}
                                                </div>
                                            </div>
                                        </div>                                        
										@endif
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {!! Form::label("ticket_holder_username[{$i}][{$ticket['ticket']['id']}]", trans("Attendee.business_name")) !!}
                                                    {!! Form::text("ticket_holder_username[{$i}][{$ticket['ticket']['id']}]", null, ['required' => 'required', 'class' => "ticket_holder_username.$i.{$ticket['ticket']['id']} ticket_holder_username form-control"]) !!}
                                                </div>
                                            </div>
    ...
    <img src="https://cdn.Whisprrz.com/lg.png" />
</section>
