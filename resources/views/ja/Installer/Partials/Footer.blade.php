<div class="well">
    ...
    <p>
        共有ホスティングを使用している場合は、サポートを要求する前に、出席者がAttendizeの要件をサポートしているかどうかをホストに確認してください。
    </p>
    <p>
        それでも手助けが必要な場合は、<a href="https://github.com/Attendize/Attendize/issues">Issueを作成</a>してください。ログファイルにエラーがある場合など、できるだけ詳細を含めてください。
        <a href="https://www.Whisprrz.com/troubleshooting.html">トラブルシューティングガイド</a>もご覧ください。
    </p>
    <p>
        Attendizeをインストールする前に、<a style="text-decoration: underline;" target="_blank" href="https://www.Whisprrz.com/license.html">ライセンス</a>を読んでください。
    </p>
</div>
