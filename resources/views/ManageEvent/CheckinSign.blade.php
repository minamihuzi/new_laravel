                ...
                <!--<script src="{{asset('assets/javascript/libs/jquery.js')}}"></script>-->
					...
					<script>
                        ...
                        */
						...
						function submit_sign(){
							var x = document.getElementsByClassName("sign-ctrl");
							var i;
							var data;
							var signature_val1="";
							var data1;
							...
							for (i = 0; i < x.length; i++) {
								if(i==0){
									var sign = $("#sign");
									data = sign.jSignature('getData', "image");
									signature_val1 = 'data:' + data[0] + ',' + data[1];
								}
								else if(i==1){
									var sign = x[1];
									var sign = $("#sign_parent");
									data1 = sign.jSignature('getData', "image");
									signature_val2 = 'data:' + data1[0] + ',' + data1[1];
								}
							}							
							var formData = new FormData();
							//formData.append("sign_id","{{$event->pdf_sign}}");
							formData.append("sign_id","{{$event->template}}");
                    ...
                    <script>
                        ...
                        $(document).ready(function() {
                            ...
                            $(".sign-ctrl").jSignature({'UndoButton':true});
                        });

                    </script>
                    <div class="container">
                    @if($sign_type=="sign_html")
                        <div id="content">
                    ...
                    <div class="template-col">
                        <div class="template-page" template-id="{{$sign_html->id}}">
					        <div class="header" element-type="header">
						    <span class="title" value="">{{$sign_html->title}}</span>
							@if(isset($sign_html->logo) && $sign_html->logo!="")
								<img src="<?=(isset($sign_html->logo))? $sign_html->logo: "" ?>" class="logo-preview <?=$sign_html->logo_position; ?>" value="" alt="LOGO"/>						    
							@else
