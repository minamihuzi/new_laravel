...
@lang("instruction.instruction06")
@stop
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th width="5%">
                               {!!Html::sortable_link(trans("Attendee.ticket"), $sort_by, 'title', $sort_order, ['q' => $q , 'page' => $orders->currentPage()])!!}
                            </th>
							<th width="5%">
                               {!!Html::sortable_link(trans("Attendee.ticket_type"), $sort_by, 'is_normal', $sort_order, ['q' => $q , 'page' => $orders->currentPage()])!!}
                            </th>
							<th width="5%">
                               {!!Html::sortable_link(trans("Attendee.profile_type"), $sort_by, 'type', $sort_order, ['q' => $q , 'page' => $orders->currentPage()])!!}
                            </th>
							<th width="6%">
