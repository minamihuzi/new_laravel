                ...
                <!--<script src="{{asset('assets/javascript/libs/jquery.js')}}"></script>-->
                    ...
                    <div class="container">
                        <div id="content">
                            ...
                            <div class="col-md-12">
                                <span>First Name:</span><input type="text" class="input_sign_ctrl" size="20"><span>M.l.</span><input type="text" class="input_sign_ctrl" size="5">
                                <span>Last name:</span><input type="text" class="input_sign_ctrl" size="20"> <span>Gender:</span><input type="text" class="input_sign_ctrl" size="5">
                            </div>
                            <div class="col-md-12">
                                <span>DOB:</span><input type="text" class="input_sign_ctrl" size="20"><span>Age:</span><input type="text" class="input_sign_ctrl" size="5">
                                <span>Emergency Number:(</span><input type="text" class="input_sign_ctrl" size="10"> <span>)</span><input type="text"  class="input_sign_ctrl" size="10"><span>-</span>
                                <input type="text" class="input_sign_ctrl" size="10">
                            </div>
                            <div class="col-md-12">
                                <span>Name of Event:</span><input type="text" class="input_sign_ctrl" size="20"><span>Start Date:</span><input type="text" class="input_sign_ctrl" size="15">
                                <span>End Date:</span><input type="text" class="input_sign_ctrl" size="15">
                            </div>
                            <div class="col-md-12">
                                <span>Activity/Sport:</span><input type="text" class="input_sign_ctrl" size="50">
                            </div>
							...
							<div class="col-md-12 col-sm-12">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="text-center"><p>Signature</p></div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div id="signatureparent1">
                                        <div id="signature1"></div>
                                    </div>
                                    <div class="text-center"><p>Parent Signature</p></div>
                                </div>
                                <div id="tools"></div>
                            </div>
							@endif
                            <div class="col-md-12 col-sm-12">
                                <div class="col-md-6 col-sm-6">
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center"><p>Participant Name (Please print legibly)</p></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="col-md-12">
                                        <input type="text" id="sign_parent_name" class="form-control">
                                        <div class="text-center"><p>Parent Name (Please print legibly)</p></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="col-md-12">
                                        <input type="text" id="sign_date_parent" class="form-control">
                                        <div class="text-center"><p>Date</p></div>
                                    </div>
                                </div>
                            </div>
