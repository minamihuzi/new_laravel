            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="custom-checkbox">
                                {!! Form::checkbox('is_hidden', 1, null, ['id' => 'is_hidden']) !!}
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<div class="custom-radio">
								{!! Form::radio('is_normal', 2, null, ['id' => 'is_normal']) !!}
					...
					<div class="col-md-12">
						<div class="form-group">
							<div class="custom-radio">
								{!! Form::radio('is_normal', 3, null, ['id' => 'is_free_n']) !!}
					...
					<div class="col-md-12">
						<div class="form-group">
							<div class="custom-radio">
								{!! Form::radio('is_normal', 4, null, ['id' => 'is_suggested_donation']) !!}
