...
@lang("instruction.instruction07")
@stop
...
<div class="col-md-9">
    <div class="btn-toolbar" role="toolbar">
        ...
        <div class="btn-group btn-group-responsive">
            <button data-modal-id="ImportGMembersAttendees" href="javascript:void(0);"  data-href="{{route('showImportGMemberAttendee', ['event_id'=>$event->id])}}" class="loadModal btn btn-success" type="button"><i class="ico-plus"></i> @lang("ManageEvent.import_group_members")</button>
        </div>
        <div class="btn-group btn-group-responsive">
...
<div class="col-md-3">
   {!! Form::open(array('url' => route('showEventAttendees', ['event_id'=>$event->id,'sort_by'=>$sort_by]), 'method' => 'get')) !!}
    <div class="input-group">
        <input type="hidden" id="group_users" name="group_users">
                ...
                <table class="table">
                    <thead>
                        <tr>
							...
							<th width="5%">
                               {!!Html::sortable_link(trans("Attendee.profile_type"), $sort_by, 'is_normal', $sort_order, ['q' => $q , 'page' => $attendees->currentPage()])!!}
                            </th>
							<th width="5%">
                               {!!Html::sortable_link(trans("Attendee.ticket_type"), $sort_by, 'ticket_id', $sort_order, ['q' => $q , 'page' => $attendees->currentPage()])!!}
                            </th>							
                            <th width="5%">
